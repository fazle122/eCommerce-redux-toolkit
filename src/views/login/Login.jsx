...
export default function Login() {
  ...
  const [googleLogin, { isLoading: isGoogleAuthLoading }] =
    useGoogleLoginMutation();
          ...
          <div className="p-6 md:p-20">
            ...
            <form onSubmit={handleSubmit(loginUser)}>
              ...
              <div className="flex flex-col md:flex-row md:my-8 justify-between space-y-8 md:space-y-0">
                <button
                  ...
                  className="w-full md:w-48 flex justify-center items-center p-6 space-x-4 font-sans font-bold text-white rounded-md shadow-lg px-9 bg-cyan-700 shadow-cyan-100"
                >
                  Log in{" "}
                </button>

                <Link className="underline px-1" to={`/forgetPass`}>
                  Forgot password
                </Link>
              </div>
            ...
            <div className="flex flex-col items-center justify-center space-x-0 space-y-6 md:flex-row md:space-x-4 md:space-y-0 ">
              ...
              <button
                ...
                className="flex items-center justify-center px-2 py-2 space-x-3 border border-gray-300 rounded md:w-1/2"
